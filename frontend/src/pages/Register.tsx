        ...
        <div className="auth-brand-section">
          <div className="brand-content">
            ...
            <div className="brand-features">
              <h2 className="features-title">Advanced Crypto Trading Signals</h2>
              <p className="features-subtitle">
                Join thousands of traders using our AI-powered platform to make smarter trading decisions
              </p>
              ...
              <div className="feature-list">
                <div className="feature-item">
                  ...
                  <div className="feature-text">
                    ...
                    <p>15-minute precision trading signals</p>
                  </div>
                </div>
                ...
                <div className="feature-item">
                  ...
                  <div className="feature-text">
                    <h3>Multi-Indicator Confluence</h3>
                    <p>RSI, MACD, Bollinger Bands & more</p>
                  </div>
                </div>
                ...
                <div className="feature-item">
                  ...
                  <div className="feature-text">
                    ...
                    <p>Monitor your portfolio in real-time</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="auth-form-section">
          <div className="form-container">
            <div className="form-header">
              ...
              <p>Start your journey to smarter trading</p>
            </div>
